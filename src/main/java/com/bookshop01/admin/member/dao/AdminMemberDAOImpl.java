...
public class AdminMemberDAOImpl  implements AdminMemberDAO{
	...
	@Override
	public void deleteMemberInfo(String member_id) throws DataAccessException {
		sqlSession.delete("mapper.admin.member.deleteMemberInfo", member_id);
		
	}
	
	@Override
	public void insertMember(MemberVO memberVO) {
		sqlSession.insert("mapper.admin.member.insertMemberInfo", memberVO);
